...
if (!class_exists('WPQT\Webhooks\WebhookService')) {
    class WebhookService
    {
        ...
        public function createWebhook($pipelineId, $args)
        {
            ...
            $result = $wpdb->insert(TABLE_WP_QUICKTASKER_WEBHOOKS, [
        ...
        public function editWebhook($webhookId, $args)
        {
            ...
            $results = $wpdb->update(TABLE_WP_QUICKTASKER_WEBHOOKS, $args, [
                'id' => $webhookId
            ]);
        ...
        public function deleteWebhook($webhookId)
        {
            ...
            $result = $wpdb->delete(TABLE_WP_QUICKTASKER_WEBHOOKS, [
                'id' => $webhookId
            ]);
        ...
        {
            return WP_QUICKTASKER_WEBHOOK_TARGET_TYPE_TASK === $webhook->target_type;
        }

        public function isTargetTypeQuicktaskerWebhook($webhook)
        {
            return WP_QUICKTASKER_WEBHOOK_TARGET_TYPE_QUICKTASKER === $webhook->target_type;
        }
        ...
        {
            $waitForResponse = '1' === $webhook->webhook_confirm;
            $requestArgs = [
