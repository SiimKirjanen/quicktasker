...
if ( ! defined( 'WP_QUICKTASKER_TASK_EXPORTS_FOLDER_DIR' ) ) {
    define('WP_QUICKTASKER_TASK_EXPORTS_FOLDER_DIR', WP_QUICKTASKER_UPLOAD_FOLDER_DIR . '/exports');
}

if ( ! defined( 'WP_QUICKTASKER_TASK_EXPORTS_FOLDER_URL' ) ) {
    define('WP_QUICKTASKER_TASK_EXPORTS_FOLDER_URL', WP_QUICKTASKER_UPLOAD_FOLDER_URL . '/exports');
}
