...
if (!function_exists('wpqt_enqueue_user_public_page')) {
    function wpqt_enqueue_user_public_page()
    {
        ...
        wp_localize_script('wpqt-script', 'wpqt_user', [
        ...
        wp_enqueue_style('wpqt-user-page-font', 'https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;700&display=swap', [], null);
