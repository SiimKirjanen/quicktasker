...
const Pipeline = () => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    (() => __awaiter(void 0, void 0, void 0, function* () {
      const pipelineData = yield (0,_api_api__WEBPACK_IMPORTED_MODULE_2__.getPipelineData)("1");
      dispatch({
        type: "SET_PIPELINE",
...
const reducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    case _constants__WEBPACK_IMPORTED_MODULE_3__.PIPELINE_MOVE_TASK:
      const stages = (0,_utils_list__WEBPACK_IMPORTED_MODULE_2__.moveTask)(state.pipeline.stages, action.payload.source, action.payload.destination);
      return Object.assign(Object.assign({}, state), {
    ...
    case _constants__WEBPACK_IMPORTED_MODULE_3__.PIPELINE_REORDER_TASK:
      ...
      const reorderedTasks = (0,_utils_list__WEBPACK_IMPORTED_MODULE_2__.reorderTask)(targetStage.tasks, source.index, targetIndex);
