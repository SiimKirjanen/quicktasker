...
function createTaskRequest(stageId, name, order) {
  return _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
    path: `/wpqt/v1/tasks`,
    method: "POST",
    data: {
...
function AddTask({
  ...
  const addTask = () => __awaiter(this, void 0, void 0, function* () {
    try {
      ...
      const createdTask = yield (0,_api_api__WEBPACK_IMPORTED_MODULE_1__.createTaskRequest)(stageId, taskName, stageTasksLength);
      dispatch({
...
const Pipeline = () => {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
    className: "wpqt-flex wpqt-gap-[24px]",
...
function Stage({
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_hello_pangea_dnd__WEBPACK_IMPORTED_MODULE_3__.Droppable, {
    droppableId: droppableId,
    children: (provided, snapshot) => (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
      ref: provided.innerRef,
      className: `wpqt-flex wpqt-flex-col wpqt-w-[280px] wpqt-max-h-full wpqt-relative wpqt-p-2 wpqt-overflow-hidden wpqt-bg-gray-100 wpqt-rounded-md ${snapshot.isDraggingOver ? "wpqt-bg-blue-400" : ""}`,
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _utils_task__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/task */ "./src/utils/task.tsx");
...
const reducer = (state, action) => {
  var _a;
  switch (action.type) {
    case _constants__WEBPACK_IMPORTED_MODULE_3__.PIPELINE_SET_LOADING:
      return Object.assign(Object.assign({}, state), {
        loading: action.payload
      });
    case _constants__WEBPACK_IMPORTED_MODULE_3__.PIPELINE_SET_PIPELINE:
      return Object.assign(Object.assign({}, state), {
        pipeline: action.payload
      });
    case _constants__WEBPACK_IMPORTED_MODULE_3__.PIPELINE_MOVE_TASK:
      const stages = (0,_utils_task__WEBPACK_IMPORTED_MODULE_2__.moveTask)(state.pipeline.stages, action.payload.source, action.payload.destination);
      return Object.assign(Object.assign({}, state), {
        pipeline: Object.assign(Object.assign({}, state.pipeline), {
          stages
        })
      });
    case _constants__WEBPACK_IMPORTED_MODULE_3__.PIPELINE_REORDER_TASK:
      const {
        source,
        destination
      } = action.payload;
    ...
    case _constants__WEBPACK_IMPORTED_MODULE_3__.PIPELINE_ADD_TASK:
      const {
        stageId,
        task: {
          id,
...
const PipelineContextProvider = ({
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    ...
    dispatch({
      type: _constants__WEBPACK_IMPORTED_MODULE_3__.PIPELINE_SET_PIPELINE,
      payload: initialFullPipeline
    });
  }, []);
  const getStageLastIndex = stageId => {
    var _a;
    const stage = (_a = state.pipeline) === null || _a === void 0 ? void 0 : _a.stages.find(stage => stage.id === stageId);
