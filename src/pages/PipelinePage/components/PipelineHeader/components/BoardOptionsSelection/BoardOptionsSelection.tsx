...
function BoardOptionsSelection() {
  ...
  return (
    <div className="wpqt-grid wpqt-grid-cols-[auto,auto,auto] wpqt-mr-2 wpqt-pr-4 wpqt-gap-x-4 wpqt-gap-y-2 wpqt-border-0 wpqt-border-r wpqt-border-solid wpqt-border-qtBorder">
      <div
