...
const PIPELINE_SET_ACTIVE_PIPELINE_DELETED_STATUS =
  "SET_ACTIVE_PIPELINE_DELETED_STATUS";
...
const UPDATE_WEBHOOKS_LOGS_MODAL_SETTINGS =
...
const UPDATE_AUTOMATION_LOGS_MODAL_SETTINGS =
  "UPDATE_AUTOMATION_LOGS_MODAL_SETTINGS";
const OPEN_API_TOKEN_LOGS_MODAL = "OPEN_API_TOKEN_LOGS_MODAL";
const CLOSE_API_TOKEN_LOGS_MODAL = "CLOSE_API_TOKEN_LOGS_MODAL";
const UPDATE_API_TOKEN_LOGS_MODAL_SETTINGS =
  "UPDATE_API_TOKEN_LOGS_MODAL_SETTINGS";
const OPEN_TASK_LOGS_MODAL = "OPEN_TASK_LOGS_MODAL";
const CLOSE_TASK_LOGS_MODAL = "CLOSE_TASK_LOGS_MODAL";
const OPEN_TASK_COMMENTS_MODAL = "OPEN_TASK_COMMENTS_MODAL";
const CLOSE_TASK_COMMENTS_MODAL = "CLOSE_TASK_COMMENTS_MODAL";
const OPEN_USER_LOGS_MODAL = "OPEN_USER_LOGS_MODAL";
const CLOSE_USER_LOGS_MODAL = "CLOSE_USER_LOGS_MODAL";
const OPEN_NOTIFICATIONS_MODAL = "OPEN_NOTIFICATIONS_MODAL";
const CLOSE_NOTIFICATIONS_MODAL = "CLOSE_NOTIFICATIONS_MODAL";
...
//Pipeline API tokens reducer
const SET_PIPELINE_API_TOKENS = "SET_PIPELINE_API_TOKENS";
const SET_PIPELINE_API_TOKENS_LOADING = "SET_PIPELINE_API_TOKENS_LOADING";
const REMOVE_PIPELINE_API_TOKEN = "REMOVE_PIPELINE_API_TOKEN";
const ADD_PIPELINE_API_TOKEN = "ADD_PIPELINE_API_TOKEN";
const SET_ACTIVE_PIPELINE_ID = "SET_ACTIVE_PIPELINE_ID";

//Missing content reducer
const SET_PIPELINE_MISSING = "SET_PIPELINE_MISSING";
const RESET_MISSING_CONTENT = "RESET_MISSING_CONTENT";
const SET_STAGE_MISSING = "SET_STAGE_MISSING";
const SET_TASK_MISSING = "SET_TASK_MISSING";
...
//Timers
const REFETCH_ACTIVE_PIPELINE_INTERVAL = 30;
const TEXT_ENTER_DEBOUNCE_TIMEOUT = 700;

//Misc
const WP_QUICKTASKER_INVALID_SESSION_TOKEN = "Invalid session token";
const WP_QUICKTASKER_USER_NOT_ACTIVE = "User is not active";
const HAS_AUTOMATIONS = true;
const HAS_WEBHOOKS = true;
const DATETIME_FORMAT = "YYYY-MM-DD HH:mm:ss";

//Styles
const DEFAULT_TASK_FOCUS_CHANGE_COLOR = "#1d4ed8";
const TASK_FOCUS_BORDER_WIDTH = "6px";
const TASK_FOCUS_BORDER_STYLE = "solid";
const DEFAULT_IMPORT_LABEL_COLOR = "#16a34a";

//API response messages
const WP_QUICKTASKER_EXCEPTION_PIPELINE_NOT_FOUND = "PIPELINE_NOT_FOUND";
const WP_QUICKTASKER_EXCEPTION_STAGE_NOT_FOUND = "STAGE_NOT_FOUND";
const WP_QUICKTASKER_EXCEPTION_TASK_NOT_FOUND = "TASK_NOT_FOUND";
...
//Notifications reducer constants
const NOTIFICATIONS_SET = "NOTIFICATIONS_SET";
const NOTIFICATIONS_SET_LOADING = "NOTIFICATIONS_SET_LOADING";
const NOTIFICATIONS_MARK_ALL_READ = "NOTIFICATIONS_MARK_ALL_READ";
const NOTIFICATION_MARK_READ = "NOTIFICATION_MARK_READ";
const NOTIFICATIONS_SET_FILTER = "NOTIFICATIONS_SET_FILTER";
const NOTIFICATIONS_SET_MAX_AGE = "NOTIFICATIONS_SET_MAX_AGE";
const NOTIFICATIONS_SET_SELECTED_PIPELINES =
  "NOTIFICATIONS_SET_SELECTED_PIPELINES";
const NOTIFICATIONS_SET_TYPE_ENABLED = "NOTIFICATIONS_SET_TYPE_ENABLED";
const DEFAULT_NOTIFICATIONS_MAX_AGE_HOURS = 24;
