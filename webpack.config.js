...
module.exports = {
  ...
  entry: {
    ...
    publicTaskBlock: path.resolve(process.cwd(), "src", "blocks", "public-task-form", "index.js"),
    publicTaskBlockView: path.resolve(process.cwd(), "src", "blocks", "public-task-form", "view.js"),
  },
  module: {
    rules: [
